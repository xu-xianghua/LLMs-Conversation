...
<body>
    ...
    <script>
        ...
        function adjustChatBoxHeight() {
            ...
            chatBox.style.height = Math.min(currentHeight, maxHeight) + "px";
        }
...
def start_conversation(model1_identity, model2_identity, scene, model1_type, model2_type):
    ...
    prompt2 = f"{scene} 你的角色是 {model2_identity}, 你将要和 {model1_identity} 开展一场对话。他先开口说话了。"
    conversation_history_2.append({"role": "user", "content": prompt2})
